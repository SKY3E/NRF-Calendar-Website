    ...
    <nav class="border-gray-200 bg-slate-800">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center">
            <img src='/calendar.png' class="h-8 mr-3" alt="Open Calendar Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Open Calendar</span>
        </a>
